...
type LoginScreenViewPropsTypes = NativeStackScreenProps<
...
export default function LoginScreenView({
  ...
  const userDeviceId = useDeviceId();
        ...
        <VStack space={3} mt="5">
          ...
          <FormControl>
            ...
            <Input
              ...
              isInvalid={
                errorInput.isError && errorInput.inputName === "userPassword"
              }
                ...
                >
                  <Icon
                    as={
                      <MaterialIcons
                        name={
                          showuserPassword ? "visibility" : "visibility-off"
                        }
                      />
                    }
                    size={5}
